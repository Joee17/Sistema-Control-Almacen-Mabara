...
<?php
              ...
              $objm=new Medidor();
              $objc=new Cuadrilla();
              $objequi=new Asignacion();
              $listaper=$objc->listar();
              $listar=$objm->listar1($_SESSION["idalmacen"]);
...
html {
  ...
  <div class="content-wrapper" id="person">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Gestionar Medidor Cuadrilla</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Sistema Mabara</a></li>
              <li class="breadcrumb-item active">Medidor Cuadrilla</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <section class="content">
      <div class="card">
              ...
              <div class="card-body">
                ...
                <form name="formcliente" action="crud/asignacion.php" method=post >
                <div class="row">
                    <div class="col-md-6" > 
                ...
                <?php
                  ...
                  ?>
                      ...
                      <div class="col-md-6">
                        <label>Medidores:</label><br>
                        <select id="txtidmedidor" name="txtidmedidor[]" class='mi-selector form-control' multiple='multiple' style="width: 100%;" required>
                <option value="">Seleccione medidor...</option>
                <?php
                  while($fila2=$listar->fetch()){//se recorre cada fila y se convierte en un array
                
                  ?>
                  <option value="<?=$fila2[0]?>"><?=$fila2[1]?> |  <?=$fila2[2]?> </option>
                  <?php
                  }
                  ?>
                ...
                <div class="row">
                    ...
                    <label for="apellidos">Fecha:</label>
                        <input type="date" name="txtfecha" id="txtfecha"  value="<?=date("Y-m-d")?>" class="form-control" autocomplete="off" onkeyup="javascript:this.value=this.value.toUpperCase();"required>
          ...
          ?>
                    <tr>
                      ...
                      <td><button type="button" id="btnEliminar" name="btnEliminar" style="  border: 1px solid ;float:left;" class="btn btn-outline-primary"  data-toggle="modal" data-target="#eliminar"  onClick="eliminar('<?=$fila1[0]?>','<?=$fila1[7]?>')"> 
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         <form id=frmEliminar action="crud/asignacion.php" method="POST" >
         <input class="form-control" type="text" id="txtoperacion" name="txtoperacion" value="eliminar" style="display:none;">
         <input class="form-control" type="text" id="txtidmedidor1" name="txtidmedidor1"  style="display:none;">
 ...
 function myFunction() {
  ...
  var url='max.php';
   ...
   function editar(id,idcuadrilla,idmedidor,fecha) {
        $("#txtoperacion").val("modificar");  
        $("#txtid").val(id);
        $("#txtidmedidor").val(idmedidor);
        $("#txtidcuadrilla").val(idcuadrilla);
        $("#txtfecha").val(fecha);
        document.getElementById('txtidmedidor').style.backgroundColor = "#EFFBFC";
        ...
        function limpiar() {
            ...
            document.getElementById('txtidmedidor').style.backgroundColor = "#FFF";
...
jQuery(document).ready(function($){
    ...
    function eliminar(id2,idmedidor) {
         $("#txtid2").val(id2);
         $("#txtidmedidor1").val(idmedidor);
