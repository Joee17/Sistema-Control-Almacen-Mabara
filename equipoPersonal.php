...
html {
  ...
  <div class="content-wrapper" id="person">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Gestionar Equipo de Personal</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="card">
              ...
              <div class="card-body">
                ...
                <form name="formcliente" action="crud/equipo_persona.php" method=post >
                <div class="row">
                    <div class="col-md-6" > 
                      ...
                      <a href="iper.php" style="  border: 1px solid ;"type="reset" class="btn btn-outline-primary"  ><i class="far fa-eye"></i> Inventario</a>
                      </div>
                </div></br>
                ...
                <?php
                  ...
                  ?>
                      ...
                      <div class="col-md-6">
                        ...
                        <select id="txtidequipo" name="txtidequipo" class='mi-selector form-control' style="width: 100%;" required>
                <option value="">Seleccione equipos...</option>
                <?php
                  while($fila2=$listar->fetch()){//se recorre cada fila y se convierte en un array
                
                  ?>
                  <option value="<?=$fila2[0]?> <?=$fila2[4]?>"><?=$fila2[3]?> | <?=$fila2[1]?> | <?=$fila2[2]?> </option>
                  <?php
                  }
                  ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="txtdescripcion" id="txtdescripcion"  placeholder="Por favor digite una descripción" class="form-control" autocomplete="off" onkeyup="javascript:this.value=this.value.toUpperCase();"required>
                    </div>
                    <div class="col-md-6">
          ...
          ?>
                    <tr>
                      ...
                      echo '<td>  <button type="button" id="btnEditar" name="btnEditar" style="  border: 1px solid ;float:left;" class="btn btn-outline-primary" data-toggle="modal" data-target="#modi"  onClick="editar1('."'".$fila1[0]."','".$fila1[6]."','".$fila1[9]."'".')">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <input class="form-control" type="text" id="txtoperacion" name="txtoperacion" value="modi" style="display:none;">
          ...
          <input class="form-control" type="text" id="txtidequipoo" name="txtidequipoo"  style="display:none;">
  ...
  <script >
        ...
        function editar1(id,idequipo,equipo) {
        $("#txtoperacion").val("modificar");  
        $("#txtid3").val(id);
        $("#txtidequipo1").val(idequipo);
        $("#txtidequipoo").val(equipo);
